...
/// These options are indicated in a bitmap of AccountRoot flags.  The bit values for the flags in the ledger are different
/// from the values used to enable or disable those flags in a transaction.  Ledger flags have names that begin with lsf.
///
