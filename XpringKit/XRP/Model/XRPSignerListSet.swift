...
public struct XRPSignerListSet: Equatable {
  ...
  /// this list.  A SignerList must have at least 1 member and no more than 8 members.
  /// No address may appear more than once in the list, nor may the Account submitting the transaction
  /// appear in the list.
