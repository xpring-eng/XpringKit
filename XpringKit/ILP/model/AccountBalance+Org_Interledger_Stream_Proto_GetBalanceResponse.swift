/// Conforms to AccountBalance struct while providing an initializer that can construct an AccountBalance from an
/// Org_Interledger_Stream_Proto_GetBalanceResponse
