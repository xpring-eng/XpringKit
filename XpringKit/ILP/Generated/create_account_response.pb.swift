...
extension Org_Interledger_Stream_Proto_CreateAccountResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _balanceSettings: Org_Interledger_Stream_Proto_CreateAccountResponse.BalanceSettings?
    var _maxPacketsPerSecond: Int32 = 0
    var _settlementEngineDetails: Org_Interledger_Stream_Proto_CreateAccountResponse.SettlementEngineDetails?
