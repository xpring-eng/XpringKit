...
internal extension XRPCurrencyAmount {
  ...
  /// - SeeAlso: [CurrencyAmount Protocol Buffer] (https://github.com/ripple/rippled/blob/develop/src/ripple/proto/org/xrpl/rpc/v1/amount.proto#L10)
  ///
  /// - Parameters:
  ///     - currencyAmount: a CurrencyAmount (protobuf object) whose field values will be used to construct an XRPCurrencyAmount
