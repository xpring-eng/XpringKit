...
extension API {
    ...
    public enum PostPathInvoice {
        ...
        public static let service = APIService<Response>(id: "post-path-invoice", tag: "", method: "POST", path: "/invoice", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: SignatureWrapperCompliance?

            public init(body: SignatureWrapperCompliance?, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(nonce: String, body: SignatureWrapperCompliance? = nil) {
                let options = Options(nonce: nonce)
