...
extension API {
    ...
    public enum PostPathReceipt {
        ...
        public static let service = APIService<Response>(id: "post-path-receipt", tag: "", method: "POST", path: "/{path}/receipt", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: Receipt?, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(path: String, body: Receipt? = nil) {
