...
struct Transaction {
  ...
  var fee: XRPAmount {
    get {return _storage._fee ?? XRPAmount()}
  ...
  var transactionData: OneOf_TransactionData? {
  ...
  /// Data specific to a the type of transaction being submitted.
  enum OneOf_TransactionData: Equatable {
    case payment(Payment)

  #if !swift(>=4.1)
    static func ==(lhs: Transaction.OneOf_TransactionData, rhs: Transaction.OneOf_TransactionData) -> Bool {
      switch (lhs, rhs) {
...
extension Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _fee: XRPAmount? = nil
    var _sequence: UInt64 = 0
    var _transactionData: Transaction.OneOf_TransactionData?
