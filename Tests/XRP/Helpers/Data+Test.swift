...
extension Data {
  ...
  public static let testPaymentChannelSignature = "30440220718D264EF05CAED7C781FF6DE298DCAC68D002562C9BF3A07C1E721B420C0DAB02203A5A4779EF4D2CCC7BC3EF886676D803A9981B928D3B8ACA483B80ECA3CD7B9B".data(
    using: .utf8
    )!
  public static let testPaymentChannelPublicKey = "32D2471DB72B27E3310F355BB33E339BF26F8392D5A93D3BC0FC3B566612DA0F0A".data(
    using: .utf8
    )!
}
