...
extension FakeIlpBalanceNetworkClient {
  ...
  static let successfulFakeNetworkClient =
    FakeIlpBalanceNetworkClient(getBalanceResult: .success(.testGetBalanceResponse))
  ...
  /// Creates a network client which will always return an RPCError with callError of the specified status code
  ///
  /// - Parameters:
